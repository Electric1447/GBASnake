...
void DrawLooseNode(SnakeNode* n, int gridOffset, int nodeSize) {
	drawRect2(gridOffset + n->x * nodeSize, gridOffset + n->y * nodeSize, nodeSize, nodeSize, COL_APPLE);
}

void ClearLooseNode(SnakeNode* n, int gridOffset, int nodeSize) {
	drawRect2(gridOffset + n->x * nodeSize, gridOffset + n->y * nodeSize, nodeSize, nodeSize, COL_BG);
}
